...
/**
 * \file    test/phpunit/PropagateDocumentFunctionalTest.php
...
/**
 * Class PropagateDocumentFunctionalTest
 *
 ...
 *
 * @package Testpropagatedocument
 */
class PropagateDocumentFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modPropagateDocument')->click();
		} else {
			// Disable the module
			$this->byHref('modPropagateDocument')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/propagatedocument/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('propagatedocument/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/propagatedocument/admin/about.php');
		$this->authenticate();
		return $this->assertContains('propagatedocument/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('propagatedocumentwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modPropagateDocument_PropagateDocumentTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modPropagateDocument_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
